            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="flex flex-col md:flex-row gap-12 items-start">
                    <div className="md:w-2/3 text-gray-900 space-y-6 text-lg text-justify">
                        <p>
                            The <b>School of Engineering</b> at IILM University aims to produce graduates with personal, academic and professional maturity to thrive in today’s competitive global job market and to create innovative, sustainable solutions to complex engineering problems. We are in a digital age and to compete with evolving skills the school offers a variety of specializations in emerging technologies. School offers program in B. Tech Biotechnology, Bioinformatics, Food Technology, Electronics & Communication Engineering (ECE) in Collaboration with L&T, Civil and Sustainable Infrastructure Engineering, Electrical and Computer Engineering, Electronics and Computer Engineering, Robotics & Artificial Intelligence etc.
                        </p>
                        <p>
                            The <b>School of Sciences (SoS)</b> at IILM University is a premier institution for students seeking a strong foundation in the fields of sciences. Its purpose is to provide a strong educational base in various scientific disciplines to students pursuing degrees in science-related fields.
