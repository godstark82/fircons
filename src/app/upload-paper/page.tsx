            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start gap-3 p-4 bg-accent/10 border border-accent/20 rounded-lg">
                ...
                <p className="text-sm">
                  ...
                  directly to{" "}
                  <a
                    href="mailto:submit@icostem.com"
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 py-4">
            <p className="text-center text-muted-foreground">
              {form.presentingPaper
                ? "Your paper has been successfully submitted to ICOSTEM 2025, hosted by Arya College, Jaipur."
                : "Your registration has been received for ICOSTEM 2025, hosted by Arya College, Jaipur."}
            </p>
