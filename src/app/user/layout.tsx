...
import { User, FileText, LogOut, LayoutDashboard, Home, Menu, X } from 'lucide-react'
...
const menuItems = [
  { title: 'Dashboard', icon: LayoutDashboard, href: '/user' },
  { title: 'My Profile', icon: User, href: '/user/profile' },
  { title: 'My Submissions', icon: FileText, href: '/user/submissions' },
]

const pageTitles: Record<string, string> = {
  '/user': 'Dashboard',
  '/user/profile': 'My Profile',
  '/user/submissions': 'My Submissions',
}
    ...
    <aside className="flex h-full w-64 shrink-0 flex-col border-r border-gray-200 bg-white">
      <div className="flex items-center gap-3 border-b border-gray-200 p-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-semibold text-gray-900">User Panel</p>
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        <header className="flex h-14 shrink-0 items-center gap-3 border-b border-gray-200 bg-white px-4">
          ...
          <h1 className="truncate text-base font-semibold text-gray-900">
            {pageTitles[pathname] || 'User Panel'}
          </h1>
        </header>
