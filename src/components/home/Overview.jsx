            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-black text-lg text-justify space-y-4">
                    <p>
                        ...
                        and in-depth discussions on recent findings. Additionally, the conference offers a platform for
                        mathematicians and researchers to present their original work, innovative ideas, and novel
                        mathematical approaches. It encourages contributions that blend theoretical advancements with
                        practical applications, fostering interdisciplinary collaboration and the exploration of
